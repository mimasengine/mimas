...
| L1 | **visplane hash** in R_FindPlane (d32xr-style) — O(n)→O(1) | Bw/P | med in plane-heavy scenes | 🟡 (core, shared w/ DoomJo; behaviourally identical) | ✓ | ✓ | ⟲⟲ | catalogued |
...
2. **L1 visplane hash** — best remaining *algorithmic* solo win, no slave, helps multi.
